...
const originFarmName = "Jeffs Coffee Farm";
const originFarmInformation = "NYC";
const originFarmLatitude = "1.2";
const originFarmLongitude = "2.4";
let productID = sku + upc;
const productNotes = "Coffee Beans";
...
it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async () => {
    ...
    await supplyChain.buyItem(upc, productPrice, { from: distributorID, value: productPrice });
    itemState = 4;
...
it("Testing smart contract function fetchItemBufferOne() that allows anyone to fetch item details from blockchain when passed string", async () => {
    const supplyChain = await SupplyChain.deployed();

    const resultBufferOne = await supplyChain.fetchItemBufferOne.call("1");
